#!/bin/bash
#
#SBATCH --job-name=adaB16_cosipy_train
#SBATCH --ntasks=1
...
for i in $(seq -w 001 050); do
  srun python COSIPY.py -c B16_config_s12b_${i}.toml -x B16_constants_s12b_${i}.toml
done

# Write out
echo "Copying files..."
rsync -avzh "$COSIPY_OUTDIR/" B16_adaprof
