...
spec_node["sdf"] = float64 
spec_node["creation_age"] = int64
spec_node["burial_age"] = int64
...
class Node:
    ...
    def get_layer_creation_age(self):
        return self.creation_age

    def get_layer_burial_age(self):
        return self.burial_age

    def set_layer_creation_age(self, age):
        self.creation_age = age

    def set_layer_burial_age(self, age):
        self.burial_age = age